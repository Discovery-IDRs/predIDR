# multiheaded with 50,100,200 kernel sizes merged into 256 dense
# increase weight of disorder by x15
...
# Build model
inputs = keras.layers.Input(shape=(None, 20), name='input')

# head 1
mask1 = layers.Masking(mask_value=0, name='mask1')(inputs)
...
# head 2
mask2 = layers.Masking(mask_value=0, name='mask2')(inputs)
...
# head 3
mask3 = layers.Masking(mask_value=0, name='mask3')(inputs)
conv31 = MaskedConv1D(128, 200, padding='same', activation='relu', name='conv1d31')(mask3)
conv32 = MaskedConv1D(128, 200, padding='same', activation='relu', name='conv1d32')(conv31)

# merge
merged = layers.concatenate([conv12, conv22, conv32], name="merge")

# interpretation
dense = layers.Dense(256, activation="relu", name="dense")(merged)
outputs = layers.Dense(2, activation='softmax', name='output')(dense)
