...
x = MaskedConv1D(128, 500, padding='same', activation='relu', name='conv1d1')(x)
x = MaskedConv1D(128, 500, padding='same', activation='relu', name='conv1d2')(x)
