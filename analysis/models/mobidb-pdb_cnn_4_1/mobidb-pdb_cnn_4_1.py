...
# Purpose:
# Examine the effect increasing the the number of 1D conv layers to 3 has on
# performance.

# Architecture:
# disorder weight: x1
# layers: x3 1D conv layers with 128 filter and 200 kernal
# epoch: 50
