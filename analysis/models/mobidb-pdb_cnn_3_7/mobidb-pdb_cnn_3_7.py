...
# Purpose:
# Examine the effect increasing the disorder weight to 100 has on performance
# and overfitting.

# Architecture:
# disorder weight: x100
...
# slight increase in accuracy, MCC, specificity, precision, and F1 compared to model
# 3.6.1. Additionally, the 3 series seems to demonstrate that the training curves look
# less and less abnormal as the disorder weight increases seeming to indicate that less
# and less overfitting is occurring. This model demonstrated normal looking training 
# curves (note the rapid initial growth of accuracy and specificity that eventually 
# levels off, something which would be expected from a model that is progressively 
# learning to make better predictions; this is in contrast to the overfitting models 
# which demonstrate abnormally good accuracy and specificity right from the start of 
# training). This model was ultimately passed over for further consideration and
