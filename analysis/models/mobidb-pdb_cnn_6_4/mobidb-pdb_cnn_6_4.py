...
# Purpose:
# Examine how increasing the epoch to 100 in combination with a x150 disorder 
# weight affects the performance.

# Architecture:
# disorder weight: x150
...
# this model resembled that of its 3 series counterpart mobidb_pdb_cnn_3_7_1 as
# described above. The training curves of this model closely follow that of 
# mobidb-pdb_cnn_3_7_1 in the beginning and continue the trend of leveling off
# which was seen at 50 epochs in the mobidb-pdb_cnn_3_7_1 training curves. Note
# however that the differences between the metrics for this model and those of
# its 3 series equivalent mobidb-pdb_cnn_3_7_1 were in general greater compared
