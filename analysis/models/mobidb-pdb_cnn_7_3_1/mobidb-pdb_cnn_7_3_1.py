...
# Purpose:
# Examine how increasing the kernal to 200 in combination with a x10 disorder weight
...
# Significance:
# Building upon mobidb-pdb_cnn_6_0, this was part of the further development of 
# mobidb-pdb_cnn_3_3 which was undertaken due to interest in the use of a x10 
# disorder weight (this makes it so that the disordered and ordered residues are
# theoretically equally represented in the dataset). This model showed improved
# accuracy, MCC, sensitivity, specificity, precision, and F1 performance compared
# to baseline model mobidb-pdb_cnn_6_0. This model shows improved sensitivity 
# performance and worse accuracy, MCC, specificity, precision, and F1 performance 
# compared to its previous counterpart mobidb-pdb_cnn_7_2_1 which used a kernal
# of 100. Like other models which used x10 disorder weight, the training curves 
...
model_name = "mobidb-pdb_cnn_7_3_1"
