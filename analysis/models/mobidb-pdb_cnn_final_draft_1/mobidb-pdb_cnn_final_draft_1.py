...
model_name = "mobidb-pdb_cnn_final_draft_1"
...
x = MaskedConv1D(128, 50, padding='same', activation='relu', name='conv1d3')(x)
x = MaskedConv1D(128, 50, padding='same', activation='relu', name='conv1d4')(x)
