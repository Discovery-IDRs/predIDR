...
# Purpose:
# Examine the effect increasing the disorder weight to 15 has on performance
# and overfitting.
...
# the accuracy, MCC, precision, F1, and specificity and the noticeable downward trend
# in sensitivity). This model was ultimately still passed over for further consideration
# and development in favor of other models which appeared to more convincingly demonstrate
