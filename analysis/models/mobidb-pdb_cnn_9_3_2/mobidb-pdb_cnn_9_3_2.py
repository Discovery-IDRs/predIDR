...
# Purpose:
# Examine the performance of a multiheaded model with a 50 kernal head and
# a 100 kernal head with a x75 disorder weight trained for x100 epochs.
...
# successful candidates from the 7 series of models). This model had increased
# accuracy, MCC, specificity, precision, and F1 performance and decreased 
# sensitivity performance when compared to the baseline model mobidb-pdb_cnn_6_2.
# Its training curves appear to be normal (features rapid initial growth of
# accuracy and specificity that eventually levels off, something which would be
...
# accuracy and specificity right from the start of training). Due to having a
# good balanced performance across most metrics, this model is being considered 
...
model_name = "mobidb-pdb_cnn_9_3_2"
...
conv12 = MaskedConv1D(128, 50, padding='same', activation='relu', name='conv1d12')(conv11)
