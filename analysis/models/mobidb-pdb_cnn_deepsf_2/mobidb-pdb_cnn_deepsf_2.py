...
model_name = "mobidb-pdb_cnn_deepsf_2"
...
x = MaskedConv1D(10, 10, padding='same', activation='relu', name='conv1d1')(x)
x = MaskedConv1D(10, 10, padding='same', activation='relu', name='conv1d2')(x)
x = MaskedConv1D(10, 10, padding='same', activation='relu', name='conv1d3')(x)
x = MaskedConv1D(10, 10, padding='same', activation='relu', name='conv1d4')(x)
x = MaskedConv1D(10, 10, padding='same', activation='relu', name='conv1d5')(x)
x = MaskedConv1D(10, 10, padding='same', activation='relu', name='conv1d6')(x)
x = MaskedConv1D(10, 10, padding='same', activation='relu', name='conv1d7')(x)
x = MaskedConv1D(10, 10, padding='same', activation='relu', name='conv1d8')(x)
x = MaskedConv1D(10, 10, padding='same', activation='relu', name='conv1d9')(x)
x = MaskedConv1D(10, 10, padding='same', activation='relu', name='conv1d10')(x)
