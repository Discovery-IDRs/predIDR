...
# Purpose:
# Examine the effect increasing the disorder weight to 500 has on performance
# and overfitting.

# Architecture:
# disorder weight: x500
...
# particular model does appear to follow the trends for MCC decreasing as disorder
# weight increases, it does differ in other aspects in that it actually shows a very
# slight increase in accuracy, specificity, precision, and F1 and a decrease in 
# sensitivity compared to model 3.8. Additionally, the 3 series seems to demonstrate
