...
# training). Note that the training curve for this specific model does have an
# abnormality at around epoch 8 (this is most noticeable as a very large dip in
# accuracy and specificity). Based on the performance of the 8 series, it appears
# that the addition of dropout did not seem to significantly improve model 
# performance. As such, while the 8 series of models may be considered for 
# further investigation in the future, they are mostly currently being set
# aside in favor of more promising models. 
...
model_name = "mobidb-pdb_cnn_8_2_2"
