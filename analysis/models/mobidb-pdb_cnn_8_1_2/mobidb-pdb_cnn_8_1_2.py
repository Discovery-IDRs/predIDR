...
# accuracy, MCC, specificity, precision, and F1 and increased sensitivity. Note
# however that this specific model had slightly better performance across almost 
# all metrics when compared to mobidb-pdb_cnn_6_2. Additionally, this series of 
# models all had generally normal looking training curves (rapid initial growth 
...
# accuracy and specificity right from the start of training). Based on the 
# performance of the 8 series, it appears that the addition of dropout did not 
# seem to significantly improve model performance. As such, while the 8 series
# of models may be considered for further investigation in the future, they are 
# mostly currently being set aside in favor of more promising models. Due to 
# actually having slightly better performance relative to baseline model 
# mobidb-pdb_cnn_6_2, this specific model is an exception to the former
# statement and is being considered for further investigation.
...
model_name = "mobidb-pdb_cnn_8_1_2"
