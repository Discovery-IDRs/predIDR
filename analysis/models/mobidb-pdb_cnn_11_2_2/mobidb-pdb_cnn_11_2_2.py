...
# to 6 in combination with a x75 disorder weight and x100 epochs
# has on performance.
...
# This specific model only predicts residues as disordered and was disregarded 
...
x = MaskedConv1D(128, 20, padding='same', activation='relu', name='conv1d3')(x)
x = MaskedConv1D(128, 20, padding='same', activation='relu', name='conv1d4')(x)
x = MaskedConv1D(128, 20, padding='same', activation='relu', name='conv1d5')(x)
x = MaskedConv1D(128, 20, padding='same', activation='relu', name='conv1d6')(x)
