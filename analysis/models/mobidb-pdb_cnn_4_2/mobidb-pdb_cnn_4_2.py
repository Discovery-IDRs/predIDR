...
# Purpose:
# Examine the effect increasing the the number of 1D conv layers to 4 has on
# performance.

# Architecture:
# disorder weight: x1
# layers: x4 1D conv layers with 128 filter and 200 kernal
# epoch: 50
