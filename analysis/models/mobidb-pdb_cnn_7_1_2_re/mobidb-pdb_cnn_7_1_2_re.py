...
model_name = "mobidb-pdb_cnn_7_1_2_re"
...
x = MaskedConv1D(128, 50, padding='same', activation='relu', name='conv1d1')(x)
x = MaskedConv1D(128, 50, padding='same', activation='relu', name='conv1d2')(x)
